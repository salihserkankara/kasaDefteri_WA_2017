<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cikan.aspx.cs" Inherits="WebApplication1.cikan" %>
...
<body>
    ...
    <div>
        ...
        <table class="auto-style1" style="background-color: #CCCCCC">
            ...
            <tr>
                <td>
                    <asp:Label ID="Label1" runat="server" Text="Çıkan Miktar="></asp:Label>
                </td>
                <td>
